...
class Empleado(models.Model):
    ...
    trabajo_en_altura = models.BooleanField(default=False)
    trabajo_en_caliente = models.BooleanField(default=False)
    trabajo_herramienta_electrica = models.BooleanField(default=False)
    trabajo_en_excavaciones = models.BooleanField(default=False)
    trabajo_espacios_confinados = models.BooleanField(default=False)
    trabajo_señalero = models.BooleanField(default=False)
